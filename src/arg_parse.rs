// TODO: Feature block this if I end up deciding to use it.
...
//             .takes_value(false)
//             .default_value("false"))
//         .arg(Arg::with_name("Enable logging")
//             .help("Enable logging posts and errors to file")
//             .long("log")
//             .short("l")
//             .takes_value(true)
//             .default_value("false"))
//         .arg(Arg::with_name("Log file")
//             .help("Path to log file, if logging is enabled.")
//             .long("logfile")
//             .short("f")
//             .takes_value(true)
//             .default_value("/var/log/tmnt.log"))
//         .get_matches();
// }
